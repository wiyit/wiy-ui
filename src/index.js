import wiyDialog, { methods as wiyDialogMethods } from './components/dialog/dialog.js';
import wiyMessage, { methods as wiyMessageMethods } from './components/message/message.js';
...
export default {
    async install(app) {
        ...
        app.registerMethods(wiyDialogMethods);
        app.registerMethods(wiyMessageMethods);
    },
};